...
Outputs:
  - /home/claude/v8/results.json       (numbers used in v8 text)
  - /home/claude/v8/scurve.pdf         (figure for v8)
  - /home/claude/v8/scurve.png         (preview)
...
def main():
    ...
    fig.tight_layout()
    fig.savefig(OUT / "scurve.pdf", bbox_inches="tight")
    fig.savefig(OUT / "scurve.png", dpi=150, bbox_inches="tight")
    ...
    for op in all_results["operating_points"]:
        print(f"  (b={op['b']}, r={op['r']}): "
              f"recall={op['recall']:.3f}, FPR={op['FPR']:.4f}, "
