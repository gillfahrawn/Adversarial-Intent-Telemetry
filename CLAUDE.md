...
| `examples/trajectory.json` | exists | Synthetic A2-class 7-turn adversarial trajectory (manifest_gen input) |
| `tools/manifest_gen.py` | exists | Rule-based manifest extractor CLI (Step 3) |
